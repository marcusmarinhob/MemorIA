...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    toast({
      ...
      description: "Bem-vindo(a) à sabIA! 🎉"
    });
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Faça login na plataforma sabIA e acesse sua área personalizada de estudos com inteligência artificial." />
      </Helmet>
